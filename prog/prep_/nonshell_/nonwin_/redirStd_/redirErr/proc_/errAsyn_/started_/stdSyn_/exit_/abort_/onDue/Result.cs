...
namespace nilnul.os.prog.prep_.nonshell_.nonwin_.redirStd_.redirErr.proc_.errAsyn_.started_.stdSyn_.exit_.abort_.onDue
{
	public class Result :
		nilnul.os.prog.run_.exit_.onDue.ResultA
		,

		nilnul.os.prog.run_.exit.ResultI
	{
