...
namespace nilnul.os.prog.prep_.shell_.xpn_
{
	...
	/// </summary>
	[Serializable]
	public class UiIsAlwaysCreated4WinException : Exception
	{
		public UiIsAlwaysCreated4WinException() { }
		public UiIsAlwaysCreated4WinException(string message) : base(message) { }
		public UiIsAlwaysCreated4WinException(string message, Exception inner) : base(message, inner) { }
		protected UiIsAlwaysCreated4WinException(
