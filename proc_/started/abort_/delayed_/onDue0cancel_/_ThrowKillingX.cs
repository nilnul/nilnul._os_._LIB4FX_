	...
	public static class _ThrowKillingX
	{
		...
		)
		{
			...
			using (var processWaited = new CancellationTokenSource())
			{
				...
				using var linkedCancel = CancellationTokenSource.CreateLinkedTokenSource(userCancelProcess, procWaitedToken);
				...
				var extendedTotal = runAftCancel + _user2close_positive;
